...
export const worldRoutes: WorldRoute[] = [
  ...
  { id: "spine-gate-values", from: "studio-gate", to: "values-plaza", kind: "studio", via: [[-1.8, 11.8]] },
  { id: "tech-gate-cloud", from: "studio-gate", to: "cloud-dock", kind: "tech", via: [[-5.8, -11.8]] },
  { id: "tech-cloud-ai", from: "cloud-dock", to: "ai-lab", kind: "tech", via: [[-17.2, -19.2]] },
  { id: "tech-ai-obs", from: "ai-lab", to: "observability-tower", kind: "tech", via: [[-27.4, -0.4]] },
  { id: "tech-obs-arch", from: "observability-tower", to: "architecture-bridge", kind: "tech", via: [[-18.6, 18.4]] },
  { id: "tech-arch-gate", from: "architecture-bridge", to: "studio-gate", kind: "tech", via: [[-5.8, 9.2]] },
  { id: "art-gate-design", from: "studio-gate", to: "design-atelier", kind: "art", via: [[10.2, -7.6]] },
  { id: "art-design-foundry", from: "design-atelier", to: "three-d-foundry", kind: "art", via: [[28.1, -1.2]] },
  { id: "art-foundry-fashion", from: "three-d-foundry", to: "fashion-room", kind: "art", via: [[20.2, 16.8]] },
  { id: "art-fashion-values", from: "fashion-room", to: "values-plaza", kind: "art", via: [[5.8, 24.4]] }
];
