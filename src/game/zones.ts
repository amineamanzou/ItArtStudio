...
export const worldRoutes: WorldRoute[] = [
  ...
  { id: "spine-gate-values", from: "studio-gate", to: "values-plaza", kind: "studio", via: [[-1.6, 8.2]] },
  { id: "tech-gate-cloud", from: "studio-gate", to: "cloud-dock", kind: "tech", via: [[-3.8, -8.6]] },
  { id: "tech-cloud-ai", from: "cloud-dock", to: "ai-lab", kind: "tech", via: [[-12.4, -14.2]] },
  { id: "tech-ai-obs", from: "ai-lab", to: "observability-tower", kind: "tech", via: [[-20.8, -0.6]] },
  { id: "tech-obs-arch", from: "observability-tower", to: "architecture-bridge", kind: "tech", via: [[-14.5, 13.2]] },
  { id: "tech-arch-gate", from: "architecture-bridge", to: "studio-gate", kind: "tech", via: [[-4.6, 6.6]] },
  { id: "art-gate-design", from: "studio-gate", to: "design-atelier", kind: "art", via: [[7.8, -5.9]] },
  { id: "art-design-foundry", from: "design-atelier", to: "three-d-foundry", kind: "art", via: [[21.6, -1.2]] },
  { id: "art-foundry-fashion", from: "three-d-foundry", to: "fashion-room", kind: "art", via: [[15.5, 13.4]] },
  { id: "art-fashion-values", from: "fashion-room", to: "values-plaza", kind: "art", via: [[4.4, 18.3]] }
];
